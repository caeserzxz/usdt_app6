...
$modules[$i]["name"] = "升级方案B";
$modules[$i]["explain"] = "B则不限制.";
$modules[$i]["val"][] = ['name'=>'referral','text'=>'直推b','input'=>'sel_role','tip'=>'个'];
//$modules[$i]["val"][] = ['name'=>'xxx','text'=>'A','input'=>'text','tip'=>'个'];
$modules[$i]["val"][] = ['name'=>'buy_type','text'=>'指定类型b','input'=>'radio','selval'=>[1=>'购买以下任意指定分销商品',2=>'购买以下全部指定分销商品']];
$modules[$i]["val"][] = ['name'=>'buy_goods','text'=>'指定分销商品b','input'=>'sel_goods'];
