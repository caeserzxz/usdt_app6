...
(function (window, document, Math) {
    ...
    DatePicker.prototype = {
        ...
        FillData: function () {
            ...
            var picker_list='<div class="pickerBG"></div>'
            picker_list += '<div class="zx_select showPicker">' +
            ...
            setTimeout(function () {
                document.querySelector('.zx_select').style.height = 'auto';
            }, 0);
        },
        ...
        eventClick: function () {
            var self = this;
            //黑幕
            document.querySelector('.pickerBG').addEventListener("touchstart", function (e) {
                e.stopPropagation();
                e.preventDefault();
                //隐藏picker
                self.HidePicker();
