...
Calendar.prototype = {
	...
	Draw: function() {
        ...
        let chazhi = firstDay = new Date(this.Year, this.Month - 1, 1).getDay();
			...
			for(var i = 1; i <= 7; i++) {
				...
				if(arr.length > 0) {
                    ...
                    if(chazhi > 0) {
                        ...
                        cell.innerHTML = "<span style='color:#CCCCCC;'>" + d + "</span>";
                        chazhi--;
                    }
					else {
                    ...
                    cell.innerHTML = "<span style='color:#CCCCCC;'>" + end_day + "</span>";
                    end_day++;
				}
