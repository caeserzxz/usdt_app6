define(['jquery.ui'], function (ui) {
    ...
    modal.initEditor = function (scroll) {
        ...
        if (goodsSelector > 0) {
            ...
            var url = diyUrlJ+'_type/query/type/good';
        ...
        if (categorySelector > 0) {
            ...
            var url = diyUrlJ+'_type/query/type/category';
            if (_this.data('goodstype') == 1) {
            ...
            _this.unbind('click').click(function () {
                biz.selector.select({name: 'category',auto: true})
            })
        }
    ...
    modal.initTpl = function () {
        tpl.helper("imgsrc", function (src) {
            ...
            if (src.indexOf('http://') == 0 || src.indexOf('https://') == 0 || src.indexOf('/static/customize/') == 0 || src.indexOf('/upload/edit_page/') == 0) {
                return src
    ...
    modal.save = function (preview) {
        ...
        if (modal.type == 1) {
            ...
            if (modal.id > 0) {
                ...
                var posturl = diyUrlJ+'/_type/save';
            } else {
