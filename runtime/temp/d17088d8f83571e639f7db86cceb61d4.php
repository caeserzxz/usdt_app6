<?php /*a:4:{s:79:"D:\phpStudy\WWW\moduleshop\application\weixin\view\sys_admin\msg_tpl\index.html";i:1549953096;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\base.html";i:1550818706;s:78:"D:\phpStudy\WWW\moduleshop\application\weixin\view\sys_admin\msg_tpl\list.html";i:1549953096;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\page.html";i:1549953095;}*/ ?>
...
<header class="header  b-b clearfix">
     ...
     <div class="page-breadcrumbs">
            ...
            <select name="type"  style="width: 200px;" data-toggle="select2" data-placeholder="按自定义筛选" data-chang="submit">
                   <option value="">全部类型</option>
                   <option value="dividend" <?php echo $search['type']=='dividend' ? 'selected' : ''; ?>>分佣相关</option>
                   <option value="withdraw" <?php echo $search['type']=='dividend' ? 'selected' : ''; ?>>提现相关</option>
                   <option value="order" <?php echo $search['type']=='order' ? 'selected' : ''; ?>>订单相关</option>
            </select>
      </div>
      </form>
</header>
...
<tr>
    ...
    <td align="center"><a href="#" data-remote="<?php echo url('ajaxEdit',array('tpl_id'=>$vo['tpl_id'],'field'=>'status')); ?>" class="<?php echo htmlentities(tplckval($vo['status'],'=1','active')); ?>"  data-toggle="class" data-ajax="true"><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a></td>
    <td><?php echo htmlentities($vo['tpl_name']); ?></td>
    <td><?php echo htmlentities($vo['tpl_code']); ?></td>
    <td><?php echo htmlentities($vo['tpl_content']); ?></td>
	<td>
<a href="<?php echo url('info',['tpl_id'=>$vo['tpl_id']]); ?>" title="编辑" class="fa fa-edit text-muted m-xs" ></a>
    </td>
</tr>
