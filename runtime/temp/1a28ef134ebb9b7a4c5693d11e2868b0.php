<?php /*a:4:{s:77:"D:\phpStudy\WWW\moduleshop\application\weixin\view\sys_admin\users\index.html";i:1549953096;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\base.html";i:1550818706;s:76:"D:\phpStudy\WWW\moduleshop\application\weixin\view\sys_admin\users\list.html";i:1549953096;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\page.html";i:1549953095;}*/ ?>
...
<?php if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tr>
        	<td><?php echo htmlentities($a['wxuid']); ?></td>
            <td><?php echo htmlentities($a['wx_nickname']); ?></td>
            <td><?php echo htmlentities($a['wx_openid']); ?></td>
          <td ><div class="headimgurl"><img src="<?php echo htmlentities($a['wx_headimgurl']); ?>" /></div></td>
          <td><?php echo htmlentities(dateTpl($a['wx_subscribe_time'])); ?></td>
            <td align="center"><a href="#" title="是否关注" class="<?php echo htmlentities(tplckval($a['subscribe'],'=1','active')); ?>" data-toggle="class" data-ajax="true"><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a></td>
            <td>
                <a href="<?php echo url('member/sys_admin.users/info',['user_id'=>$vo['user-id']]); ?>" class="m-xs" title="查看"><i class="fa fa-search text-muted"></i></a>
            </td>
        </tr>
