<?php /*a:3:{s:72:"D:\phpStudy\WWW\mainshop\application\shop\view\sys_admin\order\info.html";i:1552554678;s:69:"D:\phpStudy\WWW\mainshop\application\mainadmin\view\layouts\base.html";i:1553129665;s:69:"D:\phpStudy\WWW\mainshop\application\mainadmin\view\layouts\page.html";i:1552460091;}*/ ?>
                ...
                <div class="tab-content">
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5 form-control-static">
                                        <a href="<?php echo url('member/sys_admin.users/info',['user_id'=>$orderInfo['user_id']]); ?>" target="_blank"><?php echo htmlentities($orderInfo['user_id']); ?> - <?php echo htmlentities(userInfo($orderInfo['user_id'])); ?></a>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane" id="tabdividend">
                        ...
                        <div class="col-sm-12">
                                        ...
                                        <a href="javascript:;"
                                   data-remote="<?php echo url('upDividend',array('id'=>$orderInfo['order_id'])); ?>"
                        ...
                        <div class="col-sm-12 table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <?php if(is_array($dividend_log) || $dividend_log instanceof \think\Collection || $dividend_log instanceof \think\Paginator): $i = 0; $__LIST__ = $dividend_log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dlog): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td><a href="<?php echo url('member/sys_admin.users/info',['user_id'=>$dlog['dividend_uid']]); ?>" target="_blank"><?php echo htmlentities($dlog['dividend_uid']); ?>-<?php echo htmlentities(userInfo($dlog['dividend_uid'])); ?></a></td>
