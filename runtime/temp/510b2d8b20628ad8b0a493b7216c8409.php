<?php /*a:1:{s:80:"D:\phpStudy\WWW\moduleshop\application\shop\view\sys_admin\goods\search_box.html";i:1551402899;}*/ ?>
...
<script type="text/javascript">
	...
	function showlist(res){
	  ...
	  $.each(res.list,function(key,val){ key
		   $('#data_list').append('<tr onclick="selTr(this,'+val.goods_id+',\''+val.goods_name+'\')" ><td>'+val.goods_id+'</td><td>'+(val.is_spec==1?'多规格':val.goods_sn)+'</td><td>'+val.goods_name+'</td><td>'+(val.is_spec==1?val.show_price:val.shop_price)+'</td></tr>');
	  })	
	}
