<?php /*a:3:{s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\article\info.html";i:1549953095;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\base.html";i:1550818706;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\page.html";i:1549953095;}*/ ?>
...
<form class="form-horizontal form-validate" method="post" action="<?php echo url('info'); ?>" style="padding:0;">
      <section class="panel panel-default">
        ...
        <div class="line line-dashed line-lg pull-in"></div>
              <div class="form-group">
                  ...
                  <div class="controls" >
                      <input type="text" class="input-xlarge" data-rule-maxlength="40" data-rule-required="true" data-msg-required="文章标题不能为空" name="title" value="<?php echo htmlentities($row['title']); ?>" >
                  </div>
              </div>
           ...
           <div class="form-group">
                  ...
                  <div class="col-sm-8 must" >
                     <img class="thumb_img" name="imagefile" src="<?php echo htmlentities($row['img_url']); ?>" style="max-height: 100px;" />
                      <input class="hide" type="text" name="img_url" value="<?php echo htmlentities($row['img_url']); ?>" />
              ...
              <div class="form-group">
                  ...
                  <div class="controls wb80">
                      <textarea rows="13" class="hd" data-toggle="kindeditor"  data-tongji="remain" data-tongji-target=".js_kindeditor_tongji" data-rule-rangelength="[1,50000]" data-rule-required="true" data-msg-required="文章内容不能为空"  name="content" style="visibility:hidden;"><?php echo htmlentities($row['content']); ?></textarea>   <p class="pull-right js_kindeditor_tongji">还可输入{0}字</p>
          ...
          <header class="panel-heading bg-light">
             ...
             <div class="form-group">
                  ...
                  <label class="control-label">关键字</label>
                     <input type="text" class="input-xlarge"  name="keywords" value="<?php echo htmlentities($row['keywords']); ?>" >
              ...
              <div class="form-group">
                  ...
                  <div class="controls" >
                      <textarea name="description"  class="input-xxlarge" ><?php echo htmlentities($row['description']); ?></textarea>
                  </div>
              </div>
             <div class="form-group">
                  <label class="control-label">发布时间</label>
                  <div class="input-group w150" > <input type="text" class="input-medium" name="add_time" value="<?php echo htmlentities(dateTpl($row['add_time'])); ?>" id="solddate" data-after="#groundingdate" data-offsetday="0" readonly="readonly" data-toggle="datetimepicker" data-position="top-right"/><span class="input-group-addon"><i class="fa fa-calendar"></i></span></div> 
	...
	<input name="id" type="hidden" value="<?php echo htmlentities(intval($row['id'])); ?>">
</form>
</section>
