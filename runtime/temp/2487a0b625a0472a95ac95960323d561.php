<?php /*a:3:{s:78:"D:\phpStudy\WWW\moduleshop\application\shop\view\sys_admin\shipping\index.html";i:1549953096;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\base.html";i:1550818706;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\page.html";i:1549953095;}*/ ?>
    ...
    <section class="panel panel-default ">
        ...
        <tr>
          ...
          <td><?php echo htmlentities($row['shipping_code']); ?></td>
            ...
            <td><a href="#" data-remote="<?php echo url('ajaxEdit',array('shipping_id'=>$row['shipping_id'],'field'=>'is_front')); ?>" class="<?php echo htmlentities(tplckval($row['is_front'],'>0','active')); ?>"  data-toggle="class" data-ajax="true" ><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a></td>           
            <td><a href="#" data-remote="<?php echo url('ajaxEdit',array('shipping_id'=>$row['shipping_id'],'field'=>'status')); ?>" class="<?php echo htmlentities(tplckval($row['status'],'>0','active')); ?>"  data-toggle="class" data-ajax="true" ><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a></td>
            <td>
                <a href="<?php echo url('info',array('shipping_id'=>$row['shipping_id'])); ?>" data-toggle="ajaxModal" title="编辑">
