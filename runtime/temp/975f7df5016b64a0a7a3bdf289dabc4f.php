<?php /*a:4:{s:75:"D:\phpStudy\WWW\moduleshop\application\shop\view\sys_admin\slide\index.html";i:1549953096;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\base.html";i:1550818706;s:74:"D:\phpStudy\WWW\moduleshop\application\shop\view\sys_admin\slide\list.html";i:1549953096;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\page.html";i:1549953095;}*/ ?>
...
<header class="header  b-b clearfix">
    <form id="forms" class="talbe-search form-inline "  method="post" action="<?php echo url('getList'); ?>" >
         <div class="page-breadcrumbs">
                ...
                <a href="<?php echo url('info'); ?>" class="btn btn-sm btn-default fr m-t-md m-r"><i class="fa fa-plus m-r-xs"></i>新增幻灯片</a>
...
<?php if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?>
        <tr>
       	  	...
       	  	<td><img src="<?php echo htmlentities($g['imgurl']); ?>" style="max-width:100px;max-width:80px;"/></td>
