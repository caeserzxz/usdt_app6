<?php /*a:4:{s:80:"D:\phpStudy\WWW\moduleshop\application\member\view\sys_admin\recharge\index.html";i:1551165946;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\base.html";i:1550818706;s:79:"D:\phpStudy\WWW\moduleshop\application\member\view\sys_admin\recharge\list.html";i:1551229709;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\page.html";i:1549953095;}*/ ?>
    ...
    <form id="forms" class="talbe-search form-inline "  method="post" action="<?php echo url('getList'); ?>" >
     <div class="page-breadcrumbs">
           ...
           <select name="status"  style="width: 150px;" data-toggle="select2" data-chang="submit"  >
             ...
             <?php echo $userRechargeTypeOpt; ?>
            </select>
             <select name="pay_type"  style="width: 150px;" data-toggle="select2" data-chang="submit"  >
             <option value="">所有充值方式</option>
             <?php if(is_array($payList) || $payList instanceof \think\Collection || $payList instanceof \think\Paginator): $i = 0; $__LIST__ = $payList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['is_recharge'] == '1'): ?>
             		<option value="<?php echo htmlentities($vo['pay_code']); ?>"><?php echo htmlentities($vo['pay_name']); ?></option>
          ...
          <input type="text" class="form-control input-large" value="<?php echo htmlentities($search['keyword']); ?>" name="keyword" placeholder="会员ID" data-rule-required="true" />
...
<td><?php echo htmlentities($payment[$vo['pay_type']]['pay_name']); ?></td>
<td><?php echo htmlentities(priceFormat($vo['amount'])); ?></td>
<td><?php echo htmlentities($userRechargeType[$vo['status']]['dict_val']); ?></td>
<td><?php echo htmlentities(dateTpl($vo['update_time'])); ?></td>
<td><a href="<?php echo url('info',array('log_id'=>$vo['log_id'])); ?>" data-toggle="ajaxModal"  class="m-xs" title="编辑"><i class="fa fa-edit text-muted"></i></a></td>
</tr>
<?php endforeach; endif; else: echo "" ;endif; ?> 
</tbody>
</table>
