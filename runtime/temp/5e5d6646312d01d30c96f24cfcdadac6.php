<?php /*a:3:{s:80:"D:\phpStudy\WWW\mainshop\application\shop\view\sys_admin\shipping_tpl\index.html";i:1552460091;s:69:"D:\phpStudy\WWW\mainshop\application\mainadmin\view\layouts\base.html";i:1553129665;s:69:"D:\phpStudy\WWW\mainshop\application\mainadmin\view\layouts\page.html";i:1552460091;}*/ ?>
...
<header class="header  b-b clearfix">
     <div class="page-breadcrumbs">
            ...
            <a href="<?php echo url('info'); ?>" title="新建运费模版" class="btn btn-sm btnbtn-default fr m-t-md m-r"><i class="fa fa-plus m-r-xs"></i>新建运费模版</a>
        </div>
</header>
...
<section class="panel panel-default ">
        <header class="panel-heading">
                <?php echo $row['is_default']==1 ? '<i class="fa fa-check-square-o red">默认</i>' : ''; ?>
                
                <span class="m-r"><?php echo htmlentities($row['sf_name']); ?></span>                        
                 <span class="m-r red"><?php echo $row['consume']>0 ? "消费满".$row['consume']."包邮" : ''; ?></span>
                
                <span class="pull-right"> 
                <span class=" m-r">最后编辑时间：<?php echo htmlentities(dateTpl($row['update_time'])); ?></span>
                <a href="<?php echo url('info',['sf_id'=>$row['sf_id']]); ?>" class="m-xs" title="编辑"><i class="fa fa-edit text-muted"></i></a>
                <a  href="#" data-remote="<?php echo url('delete',['sf_id'=>$row['sf_id']]); ?>" title="删除" data-toggle="ajaxRemove" data-_confirm="您确定要删除此项吗？"><i class="fa fa-trash-o text-muted"></i></a>            
            </span>
