<?php /*a:4:{s:77:"D:\phpStudy\WWW\moduleshop\application\member\view\sys_admin\level\index.html";i:1549953095;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\base.html";i:1550818706;s:76:"D:\phpStudy\WWW\moduleshop\application\member\view\sys_admin\level\list.html";i:1549953095;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\page.html";i:1549953095;}*/ ?>
...
<header class="header  b-b clearfix">
    <form id="forms" class="talbe-search form-inline "  method="post" action="<?php echo url('getList'); ?>" >
     <div class="page-breadcrumbs">
            ...
            <a href="<?php echo url('info'); ?>" data-toggle="ajaxModal" title="添加等级" class="btn btn-sm btnbtn-default fr  m-t-md m-r"><i class="fa fa-plus m-r-xs"></i>添加等级</a>
        </div>
    </form>
</header>
...
<tr>
    <td><?php echo htmlentities($vo['level_name']); ?></td>
    <td><?php echo htmlentities($vo['min']); ?></td>
    <td><?php echo htmlentities($vo['max']); ?></td>
    <td><?php echo htmlentities($vo['level_pro']); ?>%</td>
    <td>  <a href="<?php echo url('info',array('level_id'=>$vo['level_id'])); ?>"  data-toggle="ajaxModal" class="m-xs" title="编辑">
            <i class="fa fa-edit text-muted"></i>
        </a>
        <a href="<?php echo url('delete',array('level_id'=>$vo['level_id'])); ?>" data-toggle="ajaxRemove" data-msg="确定删除 <?php echo htmlentities($vo['level_name']); ?>" class="m-xs" title="删除">
