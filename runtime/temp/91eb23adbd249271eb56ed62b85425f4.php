<?php /*a:3:{s:76:"D:\phpStudy\WWW\moduleshop\application\weixin\view\sys_admin\menu\index.html";i:1549953096;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\base.html";i:1550818706;s:71:"D:\phpStudy\WWW\moduleshop\application\mainadmin\view\layouts\page.html";i:1549953095;}*/ ?>
        ...
        <section class="panel panel-default ">
         <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal form-validate"  style="padding:0;">             
              ...
              <?php if(is_array($rows) || $rows instanceof \think\Collection || $rows instanceof \think\Paginator): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(empty($vo['pid']) || (($vo['pid'] instanceof \think\Collection || $vo['pid'] instanceof \think\Paginator ) && $vo['pid']->isEmpty())): if($i > '1'): ?></thead><?php endif; ?>
                ...
                <tr class="<?php echo $vo['icon']=='' ? 'ztr' : 'ptr'; ?>">
                 ...
                 <?php if($vo['pid'] == 0): ?><i class="fa fa-plus cursor_p add" title="添加子菜单" rel="<?php echo htmlentities($vo['id']); ?>" style="float:right; padding-right:10px; padding-top:8px;"></i><?php endif; if(($vo['icon'] != '')): ?><i class='board'></i><?php endif; ?>
                  ...
                  <td>
                    <select name="ps[<?php echo htmlentities($vo['id']); ?>][type]" id="ps_type_<?php echo htmlentities($vo['id']); ?>" class="input-small" style="width:120px;" onChange="getKeywordSelect(this,'ps',<?php echo htmlentities($vo['id']); ?>);">
            ...
            <div class="form-group m-t">
              ...
              <button id="create_menu" type="button" class="btn btn-primary" style="margin:0px 20px;">生成自定义菜单</button>
...
<script type="text/javascript">
	   ...
	   _add_menu.click(function (e) {
		   ...
		   var _menuPtrtmp = '<thead id="Submenu_'+_menu_index+'"><tr>' 
						   ...
						   + '<td>'
						   + '<select name="new[type][' + _menu_index + ']" id="new_type_' + _menu_index + '" class="input-small" style="width:120px;" onChange="getKeywordSelect(this,-1,' + _menu_index + ');">'
						   + '    <option value="0">--请选择--</option>'
						   + '	<?php echo htmlentities($WeixinEventType_opt); ?>'
						   + '</select>'
						   + '</td>'
						   + '<td>'
						   ...
						   + '<input name="new[keyword_value][' + _menu_index + ']" id="new_keyword_value_' + _menu_index + '" class="hide input-medium"  type="text"  style="width:60%">'
						   + '</td>'
